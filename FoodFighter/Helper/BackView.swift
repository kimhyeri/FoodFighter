...
extension UIViewController {
    func setDefaultView(messgae: String) {
        ...
        imageView.image = UIImage(named: applicationName)
        imageView.frame = CGRect(x: (view.frame.width - 150) / 2 ,
                                 y: 0, 
                                 width: 150, 
                                 height: 150
        )
        ...
        label.frame = CGRect(x: (view.frame.width - 300) / 2, 
                             y: 0 ,
                             width: 300,
                             height: 20
        )
